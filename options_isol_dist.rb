...
./dataset1/ERR103403_1.fastq.gz,./dataset1/ERR103404_1.fastq.gz,./dataset1/ERR103405_1.fastq.gz,./dataset1/ERR159680_1.fastq.gz -o dataset1_output -s 3,4b,5a,6,7\n"\
...
./dataset2/ERR469625_1.fastq.gz,./dataset2/ERR469626_1.fastq.gz,./dataset2/ERR469627_1.fastq.gz -o dataset2_output -s 2,3,4b,5a,6,7\n"
      opts.separator ""
